export const htmlValue = `<h1 style="text-align: start">Vuetify Pro Tiptap</h1><p style="text-align: start">A WYSIWYG rich-text editor using <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/scrumpy/tiptap">tiptap</a> and <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/vuetifyjs/vuetify">vuetify</a> for Vue.js</p><hr><h2 style="text-align: start">Demo</h2><p style="text-align: start">👉<a target="_blank" rel="noopener noreferrer nofollow" href="https://yikoyu.github.io/@datadayrepos/ddrt/">https://yikoyu.github.io/@datadayrepos/ddrt/</a></p><h2 style="text-align: start">Features</h2><ul><li><p>Use <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/vuetifyjs/vuetify">vuetify</a> components</p></li><li><p>Markdown support</p></li><li><p>TypeScript support</p></li><li><p>I18n support(<code>en</code>, <code>en</code>)</p></li><li><p>Vuetify 3.x and Vue 3.x support</p></li></ul><h2 style="text-align: start">Vuetify 2.x</h2><p style="text-align: start">For Vuetify 2.x please use the latest version of <a target="_blank" rel="noopener noreferrer nofollow" href="https://github.com/yikoyu/@datadayrepos/ddrt/tree/1.x">@datadayrepos/ddrt@1.X.X</a></p><h2 style="text-align: start">Installation</h2><h3 style="text-align: start">NPM</h3><pre><code>pnpm add @datadayrepos/ddrt
# or
yarn add @datadayrepos/ddrt
# or
npm i @datadayrepos/ddrt -S</code></pre><h3 style="text-align: start">Install plugin</h3><p>tiptap.tsmain.ts</p><h2 style="text-align: start">Global Settings</h2><pre><code>import { markRaw } from 'vue'
...
})</code></pre><h2 style="text-align: start">Custom extensions</h2><p>PreviewActionButton.vuepreview.ts</p><h2 style="text-align: start">I18n</h2><h3 style="text-align: start">Setting language</h3><p style="text-align: start">You can declare when you install the plugin.</p><pre><code>import { createTipTap } from '@datadayrepos/ddrt'

const VuetifyProTipTap = createTipTap({
  lang: 'en'
})</code></pre><p style="text-align: start">Or use <code>setLang</code> dynamic change</p><pre><code>import { locale } from '@datadayrepos/ddrt'

locale.setLang('en')</code></pre><p style="text-align: start">Available languages:</p><ul><li><p>en (default)</p></li><li><p>zhHans</p></li></ul><h3 style="text-align: start">Use unavailable language</h3><p style="text-align: start">Loading unavailable language, use <code>setMessage</code> for Settings</p><pre><code>import { locale } from '@datadayrepos/ddrt'
...
import { ref } from 'vue'
import { EditorTiptap, Viewer } from '@datadayrepos/ddrt'
import '@datadayrepos/ddrt/style.css'
import { BaseKit, Bold, Italic, Underline, Strike, Color, Highlight, Heading, Link, Image, Video, Table, Fullscreen, History } from '@datadayrepos/ddrt'
  ...
  content: [
    ...
    { type: 'heading', attrs: { textAlign: 'start', level: 3 }, content: [{ type: 'text', text: 'NPM' }] },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'pnpm add @datadayrepos/ddrt\n# or\nyarn add @datadayrepos/ddrt\n# or\nnpm i @datadayrepos/ddrt -S'
        }
      ]
    },
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: "import { createTipTap } from '@datadayrepos/ddrt'\n\nconst VuetifyProTipTap = createTipTap({\n  lang: 'en'\n})"
        }
      ]
    },
    {
    ...
    },
    {
      type: 'codeBlock',
      attrs: { language: null },
      content: [{ type: 'text', text: "import { locale } from '@datadayrepos/ddrt'\n\nlocale.setLang('en')" }]
    },
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: "import { locale } from '@datadayrepos/ddrt'\n\nlocale.setMessage('en', {\n  // i18n text\n})\nlocale.setLang('en')"
        }
      ]
    },
    ...
    { type: 'heading', attrs: { textAlign: 'start', level: 3 }, content: [{ type: 'text', text: 'EditorTiptap' }] },
    ...
    { type: 'heading', attrs: { textAlign: 'start', level: 3 }, content: [{ type: 'text', text: 'Viewer' }] },
    { type: 'heading', attrs: { textAlign: 'start', level: 4 }, content: [{ type: 'text', text: 'Props' }] },
    {
      type: 'table',
      content: [
